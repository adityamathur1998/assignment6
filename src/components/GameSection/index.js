      ...
      <GameResultViewContainer>
        <SelectedOptionContainer>
          ...
          <GameUserOptionContainer>
            ...
            <GameParticipantChoiceImage
              img={opponentChoiceObject.imageUrl}
              alt="opponent-choice"
            />
          </GameUserOptionContainer>
        </SelectedOptionContainer>
    ...
    return (
      <GameResultViewContainer>
        <SelectedOptionContainer>
          <GameUserOptionContainer>
            <GameParticipantText>YOU</GameParticipantText>
            <GameParticipantChoiceImage img={userChoiceObject.imageUrl} />
          </GameUserOptionContainer>
          <GameUserOptionContainer>
            <GameParticipantText>OPPONENT</GameParticipantText>
            <GameParticipantChoiceImage img={opponentChoiceObject.imageUrl} />
          </GameUserOptionContainer>
        </SelectedOptionContainer>
            ...
            >
              {close => (
                <PopupBody>
                  ...
                  <CloseButton tyep="button" onClick={() => close()}>
                    <RiCloseLine />
                  </CloseButton>
                </PopupBody>
              )}
